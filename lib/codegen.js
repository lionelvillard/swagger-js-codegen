            ...
            _.forEach(params, function(parameter) {
                ...
                if(parameter.in === 'body'){
                    ...
                    if (parameter.hasOwnProperty('schema')) {
                      ...
                      if (schema) {
                        addSchemaParams('body', '', schema, parameter.required, method.parameters);
                      }
                    }
...
var addSchemaParams = function(basename, name, schema, required, params) {
  var param = {
  ...
  if (schema.hasOwnProperty('properties')) {
    ...
    for (var propName in schema.properties) {
      if (schema.properties.hasOwnProperty(propName)) {
        addSchemaParams(basename, propName, schema.properties[propName], required.find(req => propName === req), params);
      }
    }
  }
}
